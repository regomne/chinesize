...
#define FILE_NAME_BEGIN 5042
#define FILE_NAME_END 5046
...
void HOOKFUNC MyProcessString(ScriptObject* obj, char** str)
{
    BYTE* ps = (BYTE*)*str;
...
void HOOKFUNC MyProcessString2(BYTE* s, char** str)
{
    ScriptObject* obj = (ScriptObject*)(s + 0x68DFA8);
