...
static const unsigned long KEYS[KEY_COUNT][56] = {
  ...
  { 0xA486D040, 0x2B74C103, 0xB34CF566, 0xD8B03018, 
    ...
    0x00000000, 0x00000000, 0x00000000, 0x00000000 },
  // ƒ^ƒyƒXƒgƒŠ[ tapestry -you will meet yourself-
...
int main(int argc, char** argv) {
  if (argc < 3) {
    ...
    fprintf(stderr, "\tkey_index =  1 -> ‚³‚©‚µ‚«l‚É‚Ý‚é‚±‚±‚ë\n");
    fprintf(stderr, "\tkey_index =  2 -> ‚ ‚é‚·™‚Ü‚®‚ÈI|ARSFMAGNA|\n");
    fprintf(stderr, "\tkey_index =  3 -> ƒ^ƒyƒXƒgƒŠ[ tapestry -you will meet yourself-\n");
    fprintf(stderr, "\tkey_index =  4 -> ‚Ç‚ñ‚¿‚á‚ñ‚ª‚«‚ã`\n");
    ...
    fprintf(stderr, "\tkey_index =  6 -> Soranica Ele|ƒ\ƒ‰ƒjƒJ ƒGƒŒ|\n");
    fprintf(stderr, "\tkey_index =  7 -> ‚Ü‚¶‚ÌƒRƒ“ƒvƒŒƒbƒNƒX DL”Å\n");
    fprintf(stderr, "\tkey_index =  8 -> PARADISE LOST V‘•”Å\n");
    fprintf(stderr, "\tkey_index =  9 -> _™î_ˆÐ_Šy ’´æs ‘ÌŒ±”Å\n");
    fprintf(stderr, "\tkey_index = 10 -> Vermilion -Bind of Blood-\n");
    fprintf(stderr, "\tkey_index = 11 -> ƒIƒƒ‹ƒ^`’¾–Ù‚Ì|`\n");
    fprintf(stderr, "\tkey_index = 12 -> _™î_ˆÐ_Šy\n");
    fprintf(stderr, "\tkey_index = 13 -> ‚©‚Ý‚Ì‚ä\n");
    fprintf(stderr, "\tkey_index = 14 -> Zero Infinity -Devil of Maxwell-\n");
    fprintf(stderr, "\tkey_index = 15 -> ‚µ‚ë‚Ì‚Ò‚©‚Ò‚©‚¨¯‚³‚Ü (v2)\n");
    fprintf(stderr, "\tkey_index = 16 -> _™î_ˆÐ_Šy Œ”VŒõ\n");
    fprintf(stderr, "\tkey_index = 17 -> BRAVA!! (v2)\n");
    fprintf(stderr, "\tkey_index = 18 -> Electro Arms -Realize Digital Dimension- (v2)\n");
    fprintf(stderr, "\tkey_index = 19 -> ‘ŠBí_ŠÙ›{‰€ ”ª–½w (v2)\n");
    return -1;
  }
