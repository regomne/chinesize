...
: -----------------------------------------
\MASM32\BIN\Ml.exe /c /coff /Cp /Zi arcpack.asm
...
: --------------------------------------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV arcpack.obj rsrc.obj
...
: -----------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV arcpack.obj
if errorlevel 1 goto errlink
dir arcpack.*
goto TheEnd
