...
: -----------------------------------------
c:\MASM32\BIN\Ml.exe /c /coff /Cp /Zi compcsx.asm
...
: --------------------------------------------------
c:\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV compcsx.obj rsrc.obj
...
: -----------------------
c:\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV compcsx.obj
if errorlevel 1 goto errlink
dir compcsx.*
goto TheEnd
