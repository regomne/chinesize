...
: -----------------------------------------
\MASM32\BIN\Ml.exe /c /coff /Cp /Zi npapack.asm
...
: --------------------------------------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV npapack.obj rsrc.obj
...
: -----------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV npapack.obj
if errorlevel 1 goto errlink
dir npapack.*
goto TheEnd
