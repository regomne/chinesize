...
: -----------------------------------------
\MASM32\BIN\Ml.exe /c /coff /Cp /Zi txtcvt.asm
...
: --------------------------------------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV txtcvt.obj rsrc.obj
...
: -----------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV txtcvt.obj
if errorlevel 1 goto errlink
dir txtcvt.*
goto TheEnd
