...
: -----------------------------------------
\MASM32\BIN\Ml.exe /c /coff /Cp /Zi comp.asm
...
: --------------------------------------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV comp.obj rsrc.obj
...
: -----------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV comp.obj
if errorlevel 1 goto errlink
dir comp.*
goto TheEnd
