...
{
    if (*strp && wcscmp(*strp, L"見上げてごらん、夜空の星を Interstellar Focus") == 0)
    {
...
BOOL WINAPI DllMain(_In_ void* _DllHandle, _In_ unsigned long _Reason, _In_opt_ void* _Reserved)
{
    if (_Reason == DLL_PROCESS_ATTACH)
    {
        ...
        static const HookPointStruct points[] = {
            ...
            { nullptr, 0xDD490, MyOpenFile1, "12", false, 0 }, //参数位置也需要适配
            { nullptr, 0xDDA63, MyOpenFile, "r", false, 0 },
            ...
            { nullptr, 0xC2A7B, MyMbtowc, "r", false, 0 },

            //wcsncmp的第二个引用所在的函数头
            { nullptr, 0x3F350, MyChangeFont_v17, "r", false, 0 },
        };
