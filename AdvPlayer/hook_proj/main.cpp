...
{
    if (*strp && wcscmp(*strp, L"桜舞う乙女のロンド") == 0)
    {
...
BOOL WINAPI DllMain(_In_ void* _DllHandle, _In_ unsigned long _Reason, _In_opt_ void* _Reserved)
{
    if (_Reason == DLL_PROCESS_ATTACH)
    {
        ...
        static const HookPointStruct points[] = {
            ...
            { nullptr, 0xC8300, MyOpenFile1, "12", false, 0 }, //参数位置也需要适配
            { nullptr, 0xC8840, MyOpenFile, "r", false, 0 },

            //1.5版本 0F B6 ?? ?? ?? 89 5C 24 ?? 8B 2C 85 ?? ?? ?? 00 85 ED 0F 84
            //根据特征码找到一个函数，其内有三次对ReadInst函数的call，hook ReadInst的函数头
            { nullptr, 0xBFF40, MyReadInst_v15, "rf", true, 0x10 },
            ...
            { nullptr, 0xBFC10, MySelString_v15, "r", false, 0 },
            ...
            { nullptr, 0xA8398, MyMbtowc, "r", false, 0 },

            //wcsncmp的第二个引用所在的函数头
            { nullptr, 0x2BBB0, MyChangeFont_v15, "r", false, 0 },
        };
