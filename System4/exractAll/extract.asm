...
MyMain proc
	...
	.if eax
		invoke MessageBox,0,$CTA0("预扫描失败！"),0,MB_ICONERROR
...
@@:
	...
	.else
		mov ecx,_nIdx
		.if ecx==246
			mov eax,$CTA0("傐偭偪傖傝彈巕妛惗/僄儘僺僠儍丒僯儍儞僐")
		.elseif ecx==219
			mov eax,$CTA0("惇敯偺儈僩/崙墹丂儔僌僫儘僢僋傾乕僋丒僗乕僷乕丒僈儞僕乕")
		.elseif ecx==247
			mov eax,$CTA0("僇僋偝傫/僇僆儖丒僋僀儞僔乕丒恄妝")
		.elseif ecx==243
			mov eax,$CTA0("撲偺岲惵擭/岝偺彨孯丂傾儗僢僋僗丒償傽儖僗")
		.elseif ecx==233
			mov eax,$CTA0("撲偺戝抝/僷僢僩儞丒儈僗僫儖僕")
		.elseif ecx==273
			mov eax,$CTA0("撲偺柡/僇儘儕傾丒僋儕働僢僩")
		.elseif ecx==201
			mov eax,$CTA0("孻柋強挿丂僄儈丒傾儖僼僅乕僰/儔僪儞挿姱偺柡丂僄儈丒傾儖僼僅乕僰")
		.elseif ecx==249
			mov eax,$CTA0("僗働偝傫/僂傿僠僞丒僗働乕僩")
		.else
			xor eax,eax
		.endif
	.endif
