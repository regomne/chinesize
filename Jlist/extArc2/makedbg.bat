...
: -----------------------------------------
\MASM32\BIN\Ml.exe /c /coff /Cp /Zi extarc.asm
...
: --------------------------------------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV extarc.obj rsrc.obj
...
: -----------------------
\MASM32\BIN\Link.exe /SUBSYSTEM:WINDOWS /DEBUG /DEBUGTYPE:CV extarc.obj
if errorlevel 1 goto errlink
dir extarc.*
goto TheEnd
